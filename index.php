    ...
    <div class="div1">
      <div class="card-group">
        <div class="card m-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              ...
              sede de Carlos mientras fue príncipe de Gales
            </p>
          </div>
        ...
        <div class="card m-2">
          ...
          <div class="card-body">
            <h5 class="card-title">
              Putin y Xi ponen a prueba su amistad “sin límites” en un
              encuentro en Samarcanda
            </h5>
            <p class="card-text">
              El presidente de China viaja a Uzbekistán y Kazajistán, su
        ...
        <div class="card m-2">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              EEl fiscal del Estado asegura que la compañía obliga a
              comerciantes más pequeños a mantener precios “artificialmente
    ...
    <div class="div2">
      <div class="card-group">
        <div class="card m-2">
          ...
          <div class="card-body">
            <h5 class="card-title">
              Ucrania busca a miles de ‘huérfanos’ dispersos por la guerra
            </h5>
            <p class="card-text">
              La agencia de la ONU para la infancia, Unicef, trata de
              localizar a 26.000 niños que fueron devueltos del sistema de
              orfanatos a sus familias o tutores legales tras la invasión
              rusa.
            </p>
          </div>
          <div class="card-footer">
            <small class="text-muted">Última actualización hace 24h.</small>
          </div>
        </div>
        <div class="card m-2">
          ...
          <div class="card-body">
            <h5 class="card-title">
              Argentina libera a la mayoría de los pasajeros del avión
              venezolano-iraní
            </h5>
            <p class="card-text">
              Todavía hay siete pasajeros que continúan detenidos en Buenos
              Aires a la espera de que avance el proceso judicial
            </p>
          </div>
          <div class="card-footer">
            <small class="text-muted">Última actualización hace 1 hora</small>
          </div>
        </div>
        <div class="card m-2">
          ...
          <div class="card-body">
            <h5 class="card-title">
              Leonardo DiCaprio rompe su regla de los 25 años en medio de
              rumores de romance con Gigi Hadid
            </h5>
            <p class="card-text">
              Según las últimas informaciones del entorno más cercano a la
              pareja, el actor y la modelo estarían "empezando a salir".
            </p>
          </div>
          <div class="card-footer">
      ...
      <div class="card mb-1">
        ...
        <div class="card-body">
          <h5 class="card-title fs-3">
            Isabel y su díscola hermana: una relación marcada por los
            escándalos de la princesa Margarita
          </h5>
          <p class="card-text fs-5">
            La princesa Margarita le dio innumerables quebraderos de cabeza a
            la reina, aunque estaban muy unidas desde niñas. El primer gran
            disgusto fue cuando se enamoró de Peter Townsend, padre de dos
            hijos y 16 años mayor que ella.
          </p>
          <p class="card-text">
