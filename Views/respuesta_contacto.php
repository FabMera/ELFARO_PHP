...
<body>
    ...
    <div class="container_total">
        ...
        <div class="div1">
            <h4 class="text-center">Estos son tus datos enviados:</h4>
            <table class="table table-striped">
                ...
                <tbody>
                    <td><?php echo htmlspecialchars($_POST['txtNombre']) ?></td>
                    <td><?php echo htmlspecialchars($_POST['txtEmail']) ?></td>
                    <td><?php echo htmlspecialchars($_POST['comentario']) ?></td>
                </tbody>
            </table>
        </div>
        <div class="footer ">
