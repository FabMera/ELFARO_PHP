      ...
      <div class="div1">
        <div class="card-group">
          <div class="card m-2">
            ...
            <div class="card-body">
              <h5 class="card-title">Djokovic no competirá en el US Open</h5>
              <p class="card-text">
                EE UU sigue sin permitir la entrada a los no vacunados y el
                serbio confirma que no viajará a Nueva York, por lo que se
          ...
          <div class="card m-2">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                francés, que no cuenta para Xavi Hernández.
              </p>
            </div>
            <div class="card-footer">
              <small class="text-muted"
          ...
          <div class="card m-2">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                Ancelotti, dominado por el Leipzig en el Bernabéu en el primer
      ...
      <div class="div3">
        <div class="list-group">
          ...
          <a href="#" class="list-group-item list-group-item">
            ...
            <p class="mb-1">
              El apagón de Raphinha y Dembélé, el encierro de Koundé en el
              lateral, la gestión de minutos en el centro del campo o el papel
      ...
      <div class="div4">
        ...
        <div class="card mb-1">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
                La Premier League confirma que rendirá un homenaje a la monarca y que, además, aplazará algunos partidos.
                Además del minuto de aplauso, los acordes del himno nacional sonarán en la previa de cada encuentro. Los entrenadores, por su parte, estarán obligados a utilizar un traje color negro.
            </p>
            <p class="card-text">
              <small class="text-muted"
                >Última actualización hace 1 semana</small
              >
            </p>
          </div>
        </div>
