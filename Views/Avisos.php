        ...
        <ol class="list-group list-group-numbered">
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="fw-bold">Se vende Propiedad UF5000</div>
                Excelente Oportunidad,acceda a un credito y compre Ahora..
                <p class="text-muted">Ir a visitar..</p>
              </div>
              <span class="badge bg-primary rounded-pill">5 visitas</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="fw-bold">Excelente Oportunidad,Vehiculo como Nuevo</div>
                Aproveche año 2021 excelentes condiciones
                <p class="text-muted">Ir a visitar..</p>
              </div>
              <span class="badge bg-primary rounded-pill">20 visitas</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-start">
              <div class="ms-2 me-auto">
                <div class="fw-bold">Se vende Excelente Computador MacBook,aproveche</div>
                Precio justo unica oportunidad $500
                <p class="text-muted">Ir a visitar..</p>
              </div>
              <span class="badge bg-primary rounded-pill">14 visitas</span>
            </li>
          </ol>
      </div>
      <div class="footer ">
